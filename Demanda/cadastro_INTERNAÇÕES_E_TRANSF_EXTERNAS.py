...
# Internal filename: Demanda\cadastro_INTERNAÇÕES_E_TRANSF_EXTERNAS.py
...
class Ui_INTERNAÇÕES_E_TRANSF_EXTERNAS:
    def setupUi(self, MainWindow, para_teladem=None):
        ...
        self.centralwidget.setGeometry(QtCore.QRect(450, 50, 540, 680))
        ...
        self.ClnicaLabel.setGeometry(QtCore.QRect(10, 200, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.Clinicaedit.setGeometry(QtCore.QRect(10, 330, 231, 31))
        ...
        self.Label_data_internacao.setGeometry(QtCore.QRect(260, 200, 251, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.Btnconf.setGeometry(QtCore.QRect(410, 635, 70, 23))
        self.Btnconf1.setGeometry(QtCore.QRect(330, 635, 70, 23))
        ...
        self.prioridade_line_edit.setGeometry(QtCore.QRect(10, 280, 231, 31))
        ...
        self.Confirm.setGeometry(QtCore.QRect(350, 610, 161, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.data_proced = QtWidgets.QDateEdit(parent=self.centralwidget)
        self.data_proced.setGeometry(QtCore.QRect(260, 170, 91, 21))
        self.data_proced.setStyleSheet('')
        self.data_proced.setDateTime(initial_datetime)
        self.data_proced.setCalendarPopup(True)
        self.data_proced.setObjectName('data_proced')
        self.data_proced.setStyleSheet('background-color: rgb(255, 255, 255);border: none;')
        self.label_proced = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_proced.setGeometry(QtCore.QRect(10, 425, 531, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.label_proced.setFont(font)
        self.label_proced.setObjectName('label_proced')
        self.date_e_hora_internacao_Edit = QtWidgets.QDateTimeEdit(parent=self.centralwidget)
        self.date_e_hora_internacao_Edit.setGeometry(QtCore.QRect(260, 220, 194, 22))
        self.date_e_hora_internacao_Edit.setDateTime(initial_datetime)
        self.date_e_hora_internacao_Edit.setCalendarPopup(True)
        self.date_e_hora_internacao_Edit.setObjectName('date_e_hora_internacao_Edit')
        self.date_e_hora_internacao_Edit.setStyleSheet('background-color: rgb(255, 255, 255);border:none;')
        self.label_pos = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_pos.setGeometry(QtCore.QRect(10, 365, 201, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.comboBox_pos.setGeometry(QtCore.QRect(10, 385, 211, 31))
        ...
        self.Contato.setGeometry(QtCore.QRect(260, 310, 221, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.Contatoedit.setGeometry(QtCore.QRect(260, 330, 231, 31))
        ...
        self.Nomesoliedit.setGeometry(QtCore.QRect(260, 280, 231, 31))
        ...
        self.Nomesol.setGeometry(QtCore.QRect(260, 260, 191, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Nomesol.setFont(font)
        self.Nomesol.setObjectName('Nomesol')
        self.text_proced = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.text_proced.setGeometry(QtCore.QRect(10, 445, 521, 151))
        self.text_proced.setStyleSheet('background-color: rgb(255, 255, 255);')
        self.text_proced.setObjectName('text_proced')
    ...
    def atualiza_banco(self):
        ...
        data_inter_obj = self.date_e_hora_internacao_Edit.date()
        hora_inter_obj = self.date_e_hora_internacao_Edit.time()
        data_proced_obj = self.data_proced.date()
        data_proced = data_proced_obj.toString('dd/MM/yyyy')
        data_inter_str = data_inter_obj.toString('dd/MM/yyyy')
        hora_inter_str = hora_inter_obj.toString('hh:mm')
        pos = self.comboBox_pos.currentText()
        procedimento = self.text_proced.text()
        ...
        comando = f"INSERT INTO tabela_internações_e_transf_externas (PRONTUARIO,NPF,DATA_E_HORA_DA_INTERNAÇÃO, DATA_HORARIO_DA_SOLICITAÇÃO, NOME_DO_PACIENTE, DATA_DE_NASCIMENTO, ORIGEM_DO_PACIENTE, DATA_DO_PROCEDIMENTO, CLÍNICA, PROCEDIMENTO, TIPO_DE_LEITO_SOLICITADO, PÓS_OPERATÓRIO_EM_CTI) VALUES (\"{pronto}\",\"{npf}\", \"{data_inter_str + ' ' + hora_inter_str}\",\"{formatted_date + ' ' + formatted_time}\",\"{name}\",\"{data_nasc}\",\"{leito_atual}\",\"{data_proced}\",\"{clinica_pac}\",\"{procedimento}\",\"{tipo_leito}\",\"{pos}\")"
        if name and data_nasc and tipo_leito and prioridade and clinica_pac:
            if data_nasc == self.dataalt.text():
                ...
                if reply == QMessageBox.StandardButton.Yes:
                    ...
                    self.teladem.add_dados_internações_e_transf_externas(data_inter_str + ' ' + hora_inter_str, formatted_date + ' ' + formatted_time, name, data_nasc, leito_atual, data_proced, clinica_pac, procedimento, tipo_leito, pos)
                    self.apagar_Demanda()
        else:  # inserted
            self.aviso = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.data_hora_proced_label.setText(_translate('MainWindow', 'DATA DO PROCEDIMENTO'))
        ...
        self.Label_data_internacao.setText(_translate('MainWindow', 'DATA E HORA  DA INTERNAÇÃO'))
        ...
        self.label_proced.setText(_translate('MainWindow', 'MOTIVO DA INTERNAÇÃO ANTECIPADA/ PROCEDIMENTO A SER REALIZADO'))
