...
# Internal filename: Demanda\cadastro_TRANSFERÊNCIAS_INTERNAS.py
...
class Ui_TRANSFERÊNCIAS_INTERNAS(object):
    def setupUi(self, MainWindow, para_teladem=None):
        ...
        self.Labeltipodeleito.setGeometry(QtCore.QRect(260, 150, 221, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.Combotipoleito.setGeometry(QtCore.QRect(260, 170, 231, 31))
        ...
        self.Confirm.setGeometry(QtCore.QRect(320, 510, 161, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.MOTIVO_textEdit = QtWidgets.QTextEdit(parent=self.centralwidget)
        self.MOTIVO_textEdit.setGeometry(QtCore.QRect(10, 230, 481, 141))
        self.MOTIVO_textEdit.setStyleSheet('background-color: rgb(255, 255, 255);')
        self.MOTIVO_textEdit.setObjectName('MOTIVO_textEdit')
        self.MOTIVO_label = QtWidgets.QLabel(parent=self.centralwidget)
        self.MOTIVO_label.setGeometry(QtCore.QRect(10, 210, 221, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.MOTIVO_label.setFont(font)
        self.MOTIVO_label.setObjectName('label')
    ...
    def procurar_paciente(self, pesquisa):
        ...
        if pesquisa != '':
            try:
                ...
                # Populando as listas com os dados obtidos
                for row in rows:
                ...
                # Configurando o QCompleter para lista_npf
    ...
    def atualiza_banco(self):
        ...
        motivo = self.MOTIVO_textEdit.toPlainText()
        ...
        comando = f"INSERT INTO tabela_transferencias_internas (PRONTUARIO,NPF, DATA_E_HORÁRIO_DA_SOLICITAÇÃO, NOME_DO_PACIENTE, DATA_DE_NASCIMENTO, LEITO_ATUAL, MOTIVO_DA_TRANSFERÊNCIA, TIPO_DE_LEITO_SOLICITADO) VALUES (\"{pronto}\",\"{npf}\",\"{formatted_date + ' ' + formatted_time}\",\"{name}\",\"{data_nasc}\",\"{leito_atual}\",\"{motivo}\",\"{tipo_leito}\")"
        if name and data_nasc and tipo_leito:
            if data_nasc == self.dataalt.text():
                ...
                if reply == QMessageBox.StandardButton.Yes:
                    ...
                    self.teladem.add_dados_transferencias_internas(formatted_date + ' ' + formatted_time, name, data_nasc, leito_atual, motivo, tipo_leito)
                    self.apagar_Demanda()
        else:  # inserted
            self.aviso = QtWidgets.QLabel(self.centralwidget)
            self.aviso.setGeometry(QtCore.QRect(10, 0, 500, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelleito_atual.setText(_translate('MainWindow', 'LEITO ATUAL '))
        self.MOTIVO_label.setText(_translate('MainWindow', 'MOTIVO DA TRANSFERÊNCIA'))
